"""
Django settings for house_plant_hub project.
...
SECRET_KEY = "django-insecure-e-4=l#5htfn85e%)cl2g17zh&d&8hpgg4n30c_k8vawyu@abg5"
...
WSGI_APPLICATION = "house_plant_hub_api.wsgi.application"
...
CSRF_TRUSTED_ORIGINS = [f"http://{config.ORIGIN}:3000", "https://houseplant-hub-api.glen-sharp.uk"]
...
SESSION_COOKIE_DOMAIN = ".glen-sharp.uk"
